			...
			>
				...
				<div className="max-w-2xl">
					<p className="text-m3-on-surface-variant leading-relaxed">
						...
						axis controls corner roundness — from <strong>sharp (0)</strong> to{" "}
		...
		<div className="w-full max-w-7xl mx-auto px-4 md:px-8 py-8 lg:py-12 flex flex-col xl:flex-row gap-12">
			<div className="flex-1 min-w-0">
				...
				<div className="mb-12">
					...
					<p className="text-lg sm:text-xl text-m3-on-surface-variant leading-relaxed max-w-2xl wrap-break-word">
						MD3 Expressive provides 30 text styles — 15 baseline and 15
						emphasized — powered by Google Sans Flex, a variable font with the{" "}
						<code className="font-mono text-base bg-m3-surface-container px-1.5 py-0.5 rounded wrap-break-word">
							ROND
						</code>{" "}
					...
					>
						<div className="flex-1">
							<p className="text-sm font-semibold text-m3-on-secondary-container">
								Live ROND axis — <span className="font-mono">{rond}</span>
							</p>
							<p className="text-xs text-m3-on-secondary-container/70 mt-0.5 wrap-break-word">
								Adjusts{" "}
								<code className="font-mono break-all sm:break-normal">
									fontVariationAxes.ROND
								</code>{" "}
								on the provider below, affecting all 30 styles simultaneously.
							</p>
						</div>
						<input
							type="range"
