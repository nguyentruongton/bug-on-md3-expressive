			...
			<div className="flex-1 min-w-0">
				...
				<div className="mb-12">
					...
					<p className="text-lg sm:text-xl text-m3-on-surface-variant leading-relaxed">
						Loading indicators display progress of a process for a short wait
						time (under 5 seconds) inside an element. They morph through 7
						unique Material design shapes.
					</p>
				</div>
					...
					>
						...
						<div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 border-b border-m3-surface-variant pb-8">
							<div className="max-w-sm">
								...
								<p className="text-sm text-m3-on-surface-variant">
									The default variant seamlessly blends into its surroundings.
									Used often in pull-to-refresh actions.
								</p>
							</div>
						...
						<div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 pb-4">
							<div className="max-w-sm">
								...
								<p className="text-sm text-m3-on-surface-variant">
									Puts the morphing indicator inside a distinct container,
									boosting visibility across varied backgrounds.
								</p>
							</div>
							<div className="flex flex-wrap items-center gap-8 justify-center min-w-50">
								<LoadingIndicator
									variant="contained"
									aria-label="Loading securely"
								/>
							</div>
						</div>
					</Card>
						...
						<div className="flex flex-col md:flex-row items-center justify-between gap-6">
							<div className="max-w-sm">
								<p className="text-sm text-m3-on-surface-variant">
									...
									<code>size</code> prop (default 24dp), seamlessly scaling
									bounds and container shapes while preserving performance.
								</p>
							</div>
					...
					>
						...
						<div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 border-b border-m3-surface-variant pb-8">
							<div className="max-w-sm">
								...
								<p className="text-sm text-m3-on-surface-variant">
									Used to indicate that an action is ongoing, such as validating
									a form or checking for updates.
								</p>
							</div>
						...
						<div className="flex flex-col md:flex-row items-start justify-between gap-6 pb-4">
							<div className="max-w-sm">
								...
								<p className="text-sm text-m3-on-surface-variant">
									The container variant should be visible when the loading
									indicator is placed over other content to provide extra
									contrast.
								</p>
							</div>
