		...
		<div className="max-w-7xl mx-auto px-4 sm:px-12 py-12 flex flex-col xl:flex-row gap-12">
			<div className="flex-1 min-w-0">
				...
				<section id="button-types" className="mb-20 scroll-mt-24">
					...
					<Card
						variant="outlined"
						className="p-8 flex flex-col gap-12 min-h-75 bg-m3-surface-container-lowest"
					>
						{/* Elevated Button */}
				...
				<section id="sizes-shapes" className="mb-20 scroll-mt-24">
					...
					<Card
						variant="outlined"
						className="p-8 flex flex-col gap-12 bg-m3-surface-container-lowest overflow-visible"
					>
